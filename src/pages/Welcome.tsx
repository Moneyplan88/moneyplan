import {IonContent, IonImg, IonPage, IonRouterLink, IonSlide, IonSlides } from '@ionic/react';
  ...
  return (
    <IonPage>
      <IonContent className='ion-padding ion-text-center'>
        <IonSlides pager={false} options={slideOpts} ref={slideOptionsRef}>
          <IonSlide>
            <h1 className="h1-onboarding">MoneyPlan</h1>
            <IonImg src={p1} className="img-onboarding" />
          ...
          <IonSlide>
            <h1 className="h1-onboarding">MoneyPlan</h1>
            <IonImg src={p2} className="img-onboarding" />
          ...
          <IonSlide>
            <h1 className="h1-onboarding">MoneyPlan</h1>
            <IonImg src={p3} className="img-onboarding" />
